...
def insertar_pri_rc():
    ...
    ds1 = obtener_query_TIGA(os.path.join(QUERIES_PRIMA_RIESGOS_CONTROLES_PATH, 'Cambios_Insert_RC.sql'))
    ...
    print(f"Progreso: {avance}%")
    rows_delete_tmp_ps =  execute_query_TIGA(os.path.join(QUERIES_PRIMA_RIESGOS_CONTROLES_PATH, 'Cambios_Delete_TG_RC.sql'))
