...
def update_ps():
    ...
    ds1 = obtener_query_TIGA(os.path.join(QUERIES_PACIFICO_RIESGOS_CONTROLES_PATH, 'Cambios_update.sql'))
    ...
    avance = 60
    print(f"Progreso: {avance}%") 
    rows_update_tmp_to_compare_ps = execute_query_TIGA(os.path.join(QUERIES_PACIFICO_RIESGOS_CONTROLES_PATH, 'Update_TMP_to_compare.sql'))
    print("filas afectadas:",rows_update_tmp_to_compare_ps)
